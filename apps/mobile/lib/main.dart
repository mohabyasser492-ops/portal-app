...
import 'features/requests/application/requests_providers.dart';
import 'features/requests/data/fake_requests_repository.dart';
...
void main() {
  ...
  final requestsRepository = FakeRequestsRepository();
